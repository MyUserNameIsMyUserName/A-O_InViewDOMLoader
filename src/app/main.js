...
const V_App = {
  ...
  isDev() {
    ...
    console.log(`[ V_App.isDev() -> < this->config->isDev > = ${this.config.isDev} ]`);
    return isDev;
  },
  healthCheck() {
		var returnVal = false;
    ...
    if (V_App) {
      ...
      console.warn("V_App.healthCheck() function has not found the main object, how are you running this???");
      console.log(this);
			returnVal = false;
    }
		console.groupEnd();
  ...
  init() {
    ...
    console.log("System Booted In : " +(this.config.system.bootTime - this.config.system.iniTime) +"ms ;");
