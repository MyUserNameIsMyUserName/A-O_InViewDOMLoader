  ...
  pathways: [
    {
      ...
      pageInfo: {
        ...
        page_keywords:
          "Slavko V., Vuletic, Vuletic Slavko, Slavko Vuletic, Tech Enthusiast, Developer, Designer, Gamer, Web pathwayr, Custom Web Tech, Modern Demo ",
    ...
    },
    {
      ...
      pageInfo: {
        ...
        page_keywords:
          "Slavko V., Vuletic, Vuletic Slavko, Slavko Vuletic, Contact Page, Contact, Contact Me, Send Message, Send Email",
        logo_base_img: "/assets/img/logo.png",
        logo_alt_img:
          "https://raw.githubusercontent.com/MyUserNameIsMyUserName/A-O_documentation_maker/fukinMASTER/SOURCE/static/assets/img/logo.png",
...
function findCurrentRoute() {
  const development = new URLSearchParams(window.location.search).get(
    "development"
  );
  ...
  if (development) {
    ...
    loadScript("/ao_modules/ao_egah.js", function () {
      wnd.dispatchEvent(new Event("ssosl_ready"));
    });
  }
