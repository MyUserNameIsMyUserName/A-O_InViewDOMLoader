...
app.get("/", (req, res) => {
  res.send("Hello World! <br> page_slug: " +req.params.page_slug+" ; <br> req.baseUrl : "+req.baseUrl+" ; <br> is_dev: "+is_dev()+" ; <br> "+ v_dom_printer.init()+" ; <br> "+ v_dom_printer.print()+" ; <br> "+ v_dom_printer.findTemplate('script_file_chunk') );
});
